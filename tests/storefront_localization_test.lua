...
local function runTests()
    ...
    assertTest(str_es_install == "Complemento \"koinsight\" (versión 0.2.3) instalado."
        or str_es_install == "Se instaló el complemento \"koinsight\" (versión 0.2.3).",
        "Spanish quoted install notification", "Got: " .. tostring(str_es_install))
